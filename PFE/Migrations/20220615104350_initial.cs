        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SoutenancesId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_EncadrantSoutenance", x => new { x.JuryId, x.SoutenancesId });
                    table.ForeignKey(
                        name: "FK_EncadrantSoutenance_Encadrants_JuryId",
                        column: x => x.JuryId,
                        principalTable: "Encadrants",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Encadrants_UserId",
                table: "Encadrants",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_EncadrantSoutenance_SoutenancesId",
                table: "EncadrantSoutenance",
                column: "SoutenancesId");
